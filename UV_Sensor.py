...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        formLayot.addRow("UV Level",self.UV)
...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        print('Next update')
        uvLvl = random.randrange(0,9)
        current_data='UV Level: '+str(uvLvl)
        self.connectionDock.UV.setText(str(uvLvl))
